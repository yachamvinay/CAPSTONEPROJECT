...
public class AnswerController {
    ...
    public Answer createAnswer(@PathVariable("id") Long id,@RequestBody Answer answer, Principal principal) throws Exception {
        ...
        String message = "New Answer Added" + "\n" +
                "Question - " + answer.getAnswer() + "\n" +
                "User - "+user.getUsername() + "   |   " +
                "Created Date - "+date.toString();
        String to = "dconnecteam@gmail.com";
    ...
    @RequestMapping(value = "/delete-answer/{id}", method = RequestMethod.DELETE)
    public void deleteAnswer(@PathVariable("id") Long id, Principal principal){
