...
export class AnswerService {
  ...
  public approveAnswer(id:any){
    return this._http.post(`${baseUrl}/user/approve-answer/${id}`,id);
  }

  public disableAnswer(id:any){
    return this._http.post(`${baseUrl}/user/disable-answer/${id}`,id);
  }

  public deleteANswerById(id:any){
    return this._http.delete(`${baseUrl}/user/deleteAnswerNow/${id}`);
  }
