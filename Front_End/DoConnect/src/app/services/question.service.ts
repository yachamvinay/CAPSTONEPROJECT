...
export class QuestionService {
  ...
  public approveQuesion(id:any){
    return this._http.post(`${baseUrl}/user/approve-question/${id}`, id);
  }

  public disableQuesion(id:any){
    return this._http.post(`${baseUrl}/user/disabled-question/${id}`, id);
  }

  public deleteQuestionById(id:any){
    return this._http.delete(`${baseUrl}/user/delete-question/${id}`);
  }
